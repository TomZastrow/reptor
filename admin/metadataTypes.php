            ...
            $(document).ready(function () {
                ...
                $("#onExecute").click(function () {
                    ...
                    if (theText == "") {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'metadataFunctions.php?verb=saveMetadataTypes&path=' + thePath,
                            data: {'Text': theText},
                            dataType: 'text'
                        })
                                .done(function (data) {
                ...
                <div class='panel-body'>
                    <div class="starter-template">
                        ...
                        <form style="width:400px;">
                            <div class="form-group">
                                <label for="metadataTypes">Metadata:</label>
                                <textarea class="form-control" rows="5" id="metadataTypes"></textarea>
                            </div>
                        </form>
                        <br />
